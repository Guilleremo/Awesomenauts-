game.SpendExp = me.ScreenObject.extend({
	...
	onResetEvent: function() {	
		...
		me.game.world.addChild(new (me.Renderable.extend({
			...
			draw: function(renderer){
				...
				this.font.draw(renderer.getContext(), "F1: INCREASE GOLD PRODUNCTION! CURRENT LEVEL: " + exp1cost + "COST: " + ((game.data.exp1 + 1) * 10), this.pos.x, this.pos.y + 100);
	...
	onDestroyEvent: function() {
		...
		me.input.unbinKey(me.input.KEY.F5, "F5");
