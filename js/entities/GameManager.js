...
game.ExperienceManager = Object.extend({
    ...
    startBuying: function(){
        ...
        game.data.pausePos = me.game.localToWorld(0, 0);
    ...
    stopBuying: function(){
        ...
        game.data.player.body.setVelocity(game.data.playerMoveSeed, 20);
    ...
    checkCost: function(skill){
        if(skill===1 && (game.data.gold >= ((game.data.skill1+1)*10))){
            ...
            return true;
        }else if(skill===4 && (game.data.gold >= ((game.data.skill1+4)*10))){
            return true;
        }else if(skill===5 && (game.data.gold >= ((game.data.skill1+5)*10))){
            return true;
        }else if(skill===6 && (game.data.gold >= ((game.data.skill1+6)*10))){
            return true;
        }else
            return false;
        }
