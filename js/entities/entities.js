...
game.EnemyCreep = me.Entity.extend({
    init: function(x, y, settings){
        ...
        this.alwaysUpdate = true;
        //this.attacking is letting us know if the creep is currently attacking
        this.attacking = false;
        //keeps track of when our creep last attacked anything
        this.lastAttacking = new Date().getTime();
        //keep track of the lasttime or creep hit anything 
    ...
    collideHandler: function(response){
    	if(response.b.type==='PlayerBase'){
    		...
    		if((this.now-this.lastHit >= 1000)){
    			...
    			this.lastHit = this.now;
    			//makes the player base call its longHealth function and passes it a 
    			//damage of 1
    			repsonse.b.loseHealth(game.data.enemyCreepAttack);
    		}
    		...
    		if((this.now-this.lastHit >= 1000) && xdif>0){
    			//updates the lastHit timer
    			this.lastHit = this.now;
    			//makes the player call its longHealth function and passes it a 
    			//damage of 1
...
game.GameManager = Object.extend({
    ...
    update: function(){
        ...
        if(Math.round(this.now/1000)%10 ===0 && (this.now - this.lastCreep >= 1000)){
        	game.data.gold += 1;
        	console.log("Cosole gold: " + game.data.gold);
        }
